// Package update reports whether a newer jira-cli release is available.
//
...
const DefaultEndpoint = "https://api.github.com/repos/angelmsger/jira-cli/releases/latest"
...
const EndpointEnv = "JIRA_RELEASE_API"
...
func compare(current, latest string) Status {
	...
	if less(cur, lat) {
		...
		st.Detail = fmt.Sprintf(
			...
			current, latest, "https://github.com/angelmsger/jira-cli/releases/latest")
		return st
	}
