...
const (
	...
	envContextOverride = "JIRA_CONTEXT"
	// envNoContextHint opts out of the runtime multi-context nudge entirely.
	envNoContextHint = "JIRA_CLI_NO_CONTEXT_HINT"
)
...
//   - the context was selected explicitly (--use-context / JIRA_CONTEXT),
//   - a human is at the terminal (stderr is a TTY),
//   - the command is a setup/meta command or a non-runnable group, or
//   - the nudge is opted out (JIRA_CLI_NO_CONTEXT_HINT).
//
